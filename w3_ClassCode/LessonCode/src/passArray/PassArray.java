...
// Fig. 7.13: PassArray.PassArray.java
...
public class PassArray {
    ...
    public static void modifyArray(int array2[]) {
        for (int counter = 0; counter < array2.length;
             counter++)
            array2[counter] *= 2;
    ...
    public static void modifyElement(int element) {
...
} // end class PassArray.PassArray

        /*******************************************************
        *******************
        *(C)Copyright 1992-2014by Deitel&Associates,Inc.
        and*
        ...
        *DISCLAIMER:The authors and publisher of this book
        ...
        include the*
        *development,research,and testing of the theories
        and programs*
